...
public class NextAndPrev {
	/*we have to flip the rightmost non-trailing zero first
	 * After that we need to put all trailing zeros plus a zero and 
	 * all other 1s to be shifted rightward*/
	public static int getNext(int n) {
		...
		n = n | (1 << pos); // Flip right-most non-trailing zero
		 ...
		 * (4) AND with n
		 */
		n = n & ~((1 << pos) - 1); // Clear all bits to the right of pos
	...
	public static void main(String[] args) {
		int i = 13948;
		Integer p1 = getPrev(i);
		Integer n1 = getNext(i);
		System.out.println("Curr : "+i +" : "+Integer.toBinaryString(i));
		System.out.println("Prev : "+p1+" : "+Integer.toBinaryString(p1));
		System.out.println("Next : "+n1+" : "+Integer.toBinaryString(n1));
...
/*
Curr : 13948 : 11011001111100
Prev : 13946 : 11011001111010
Next : 13967 : 11011010001111
*/
